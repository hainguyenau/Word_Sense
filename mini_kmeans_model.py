...
# Fit mini batch KMeans model, return both km model and number of clusters
def model_fit(word, pos, vectors):
    km = MiniBatchKMeans(n_clusters = get_num_meanings(word, pos), init='k-means++', max_iter=100, n_init=1)
    km.fit(vectors)
